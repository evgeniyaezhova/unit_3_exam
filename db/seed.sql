DROP DATABASE IF EXISTS marbiores;
CREATE DATABASE marbiores;
...
INSERT INTO researchers(res_name, job_title) VALUES ('Mariana Aleta', 'Project Lead'),
...
INSERT INTO species(spec_name, is_mammal) VALUES ('Dolphin', TRUE),
('Moray Eel', FALSE),
('Tiger Shark', FALSE),
('Orca Whale', TRUE),
('Moon Jelly', FALSE);
